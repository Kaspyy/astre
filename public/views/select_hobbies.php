...
<body>
    <div class="edit-profile-screen-background">
        ...
        <div class="control-group">
            ...
            <label class="control control--checkbox">Politics
                <input type="checkbox" />
                <div class="control__indicator"></div>
            </label>
            ...
            <label class="control control--checkbox">Photography
                <input type="checkbox" />
                <div class="control__indicator"></div>
            </label>
            <label class="control control--checkbox">Art
                <input type="checkbox" />
                <div class="control__indicator"></div>
            </label>
        </div>
